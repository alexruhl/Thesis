...
public class QuestionsFesteZeitenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_questions_feste_zeiten);
    ...
    public void goToNextPage(View view) {
        Intent intent = new Intent(this, QuestionsPLZActivity.class);
        //Read Bundle
